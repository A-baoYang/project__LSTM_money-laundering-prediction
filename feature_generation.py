...
cond_list = [
    ...
    ((df['all_action_types'].str.contains('保單貸款|保單借款')) & (df['all_action_type'].str.contains('轉帳'))) | (df['all_action_type'].str.contains('國壽保單借款')) & (df['twd_amt']>0),
    (df['all_action_types'].str.contains('外匯')) & (df['all_action_type'].str.contains('轉帳')) & (df['twd_amt'] > 0),
    (df['all_action_types'].str.contains('理財型房貸')) & (df['all_action_type'].str.contains('轉帳')) & (df['twd_amt'] > 0),
    (df['all_action_types'].str.contains('電子式存單')) & (df['all_action_type'].str.contains('轉帳')) & (df['twd_amt'] > 0),
    (df['all_action_types'].str.contains('網銀約轉')) & (df['all_action_type'].str.contains('轉帳')) & (df['twd_amt'] > 0),
    (df['all_action_types'].str.contains('網銀非約轉')) & (df['all_action_type'].str.contains('轉帳')) & (df['twd_amt'] > 0),
    (df['all_action_types'].str.contains('信用卡')) & (df['all_action_type'].str.contains('轉帳')) & (df['twd_amt'] > 0),
    (df['all_action_types'].str.contains('存單開戶存摺扣款')) & (df['all_action_type'].str.contains('轉帳')) & (df['twd_amt'] > 0),
    ...
    (df['all_action_types'].str.contains('存款')) & (df['all_action_type'].str.contains('現金貸方')),
    (df['all_action_types'].str.contains('保單|理財')) & (df['all_action_type'].str.contains('現金借方')),
    ...
    (df['all_action_types'].str.contains('約定帳號查詢')) & (df['all_action_type'].str.contains('查詢')),
    (df['all_action_types'].str.contains('存款')) & (df['all_action_type'].str.contains('查詢')),
    (df['all_action_types'].str.contains('卡片')) & (df['all_action_type'].str.contains('查詢')),
    (~df['all_action_types'].str.contains('約定帳號查詢|存款|卡片')) & (df['all_action_type'].str.contains('查詢')),
    ((df['all_action_types'].str.contains('一般_轉換')) | df['all_action_type'].str.contains('unknown _')) & (df['twd_amt'] > 0),
...
dummy_cashFlow.columns = ['cash_flow' + str(x) for x in [-1, 0, 1]]
